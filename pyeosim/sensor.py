...
class TdiCmos(GenericTransformer):
    """
    Time Delay Integration CMOS generic transformer. This version does not
    apply spectral resampling and relies on band integration happening in the
    ...
    def __init__(self, sensor_altitude=5e5, sensor_ground_speed=7000,
        ...
        store_steps : bool
            ...
            attribute
        apply_spatial_resampling : bool
            if True, spatial response function will be applied. Use False for
            supplying non-imaging data to the simulation
        """
        super().__init__()
